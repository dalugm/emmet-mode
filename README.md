...
- [Emmet mode](#emmet-mode)
    - [About zencoding-mode](#about-zencoding-mode)
    - [About Emmet](#about-emmet)
    - [Abbreviation Examples](#abbreviation-examples)
    - [Emmet Actions](#emmet-actions)
    - [Supported Emacs](#supported-emacs)
    - [Installation](#installation)
        - [1. From marmalade or MELPA](#1-from-marmalade-or-melpa)
        - [1. Manual Installation](#1-manual-installation)
        - [2. Settings to use.](#2-settings-to-use)
        - [3. Optional settings](#3-optional-settings)
        - [4. JSX Support](#4-jsx-support)
    - [Usage](#usage)
    - [HTML abbreviations](#html-abbreviations)
        ...
        - [Filter: HTML with comments](#filter-html-with-comments)
        - [Filter: HAML](#filter-haml)
        - [Filter: Hiccup](#filter-hiccup)
    ...
    - [CSS abbreviations](#css-abbreviations)
        ...
        - [Unitless property](#unitless-property)
...
[zencoding-mode](https://github.com/rooney/zencoding) is a minor mode providing
support for Zen Coding by producing HTML from CSS-like selectors. See
[README](https://github.com/rooney/zencoding/blob/master/README.md)

## About Emmet

Zen Coding has been renamed to [Emmet](http://emmet.io/) and includes an
...
If your Emacs has the [marmalade](http://marmalade-repo.org/) or
[MELPA](http://melpa.milkbox.net/) package repositories installed, just type
`M-x package-list-packages`, search for `emmet-mode`, and install it.
...
If you manually installed emmet-mode to `~/emacs.d/emmet-mode/`, add the
following lines to your init.el or .emacs:
...
If current major-mode is in `emmet-jsx-major-modes`, then JSX features will be
supported:
...
alias your preferred keystroke to M-x emmet-expand-line) and you'll transform
your snippet into the appropriate tag structure.
